...
public class CurveAndLrc extends SurfaceView implements android.view.SurfaceHolder.Callback {
	...
	public int sentenceFlag;// 当前句子的游标

	public int chapterFlag;// 当前字的游标
	...
	public float firstSenStartX, firstSenStartY, secSenStartX, secSenStartY;// 歌词区域第一句和第二局的起始坐标
	...
	public float timeDensity;// 单位时间在曲线区域中的长度
